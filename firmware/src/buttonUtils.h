...
int read_LCD_buttons()
{
  ...
  if (adc_key_in < 195)  { delay(200); return btnUP;}
  if (adc_key_in < 380)  { delay(200); return btnDOWN;}
  if (adc_key_in < 555)  { delay(200); return btnLEFT;}
  if (adc_key_in < 790)  { delay(200); return btnTIMER;}
  return btnNONE;
}
